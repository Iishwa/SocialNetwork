...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		if($check == 1){//to match email from database if it exists
		...
		$rand = rand(1, 3); //Random number between 1 and 3
			...
			if($rand == 1)
				$profile_pic = "images/d.png";
			else if($rand == 2)
				$profile_pic = "images/e.png";
			else if($rand == 3)
				$profile_pic = "images/f.jpg";
		...
		values('$first_name','$last_name','$username','Hello Peoples World.This is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','coverr.jpg',NOW(),'$status','$posts','Who was your first crush.')";
