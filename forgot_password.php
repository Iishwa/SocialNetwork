		...
		<div class="main-content">
			...
			<div class="l_pass">
				<form action="" method="post">
					...
					<pre class="text">Enter the worst place you know</pre>
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
						<input type="text" class="form-control" name="recovery_account"  placeholder="Place?" id="msg" required>
					</div><br>
					<a style="text-decoration: none; float: right; color: #187FAB" data-toggle="tooltip" title="signin" href="signin.php">Back to Login?</a><br><br>
