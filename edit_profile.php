							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<form action="recovery.php?id=<?php echo $user_id;?>" method="post" id="f">
										<strong>Which is your worst place in the world?</strong>
										<textarea class="form-control" cols="83" rows="4" name="content" placeholder="place"></textarea><br>
										<input  class="btn btn-default" type="submit" name="sub" value="submit" style="width: 100px;" ><br><br>
										<pre>Answer the above question in case you forgot your <br>password</pre><br><br>
									</form>
									<?php 
									if(isset($_POST['sub'])){
