...
<style>
#scroll_messages{max-height: 500px;
	overflow: scroll;
...
<div class='col-sm-3' id='select_user'>
		...
		<div class='container-fluid'>
			...
			<strong>&nbsp&nbsp$first_name $last_name</strong></a>
			</div>
	";
	}
?>
...
<div class="col-sm-6">
	<div class="load_msg" id="scroll_messages">
			 ...
			 <div id='loaded_msg'>
			 	<p><?php 
			 		if($user_to==$user_to_msg AND $user_from ==
			 		$user_from_msg){
...
if(isset($_GET['u_id'])){
	...
	if($u_id=="new")
	{
		echo '
		<form>
			<center><h3>Select friend to have conversation</h3></center>
			<textarea disabled class="form-control" placeholder="Enter your message "></textarea>
			<input type="submit" class="btn btn-default" disabled value="send"></form><br><br>';
	}
	else {
	echo'
	       <form action="" method="POST">
			
			<textarea  class="form-control" placeholder="Enter your message " name="msg_box" id="msg_textarea"></textarea>
			<input type="submit" name="send_msg" id="btn_msg" value="send"></form><br><br>';
...
if(isset($_POST['send_msg'])){
	...
	if($msg=="")
	{
		echo"<h4 style='color: red; text-align: center;'>Bhai kuchh likh toh sahi aese hi chutiyaa bnaa rhai!!!</h4>";
	}
	else if(strlen($msg)>100){
	echo"<h4 style='color: red; text-align: center;'>Message is too long use only 100 character</h4>";
}else{
...
echo"<div class='row'>
	...
	<center><div style='background-color: #e6e6e6;' class='col-sm-9'>
		...
		<ul class='list-group'>
			<li class='list-group-item' title='username'><strong style='color:grey;'>$f_name $l_name</strong></li>
